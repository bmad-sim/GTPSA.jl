...
function copy!(t::NewTPS{Float64}, t1::NewTPS{Float64})
  @ccall MAD_TPSA.mad_tpsa_copy(t1::Ptr{NewTPS{Float64}}, t::Ptr{NewTPS{Float64}})::Cvoid
  return t
end

function copy!(t::NewTPS{ComplexF64}, t1::NewTPS{ComplexF64})
  @ccall MAD_TPSA.mad_ctpsa_copy(t1::Ptr{NewTPS{ComplexF64}}, t::Ptr{NewTPS{ComplexF64}})::Cvoid
  return t
end

function copy!(ct::NewTPS{ComplexF64}, t1::NewTPS{Float64})
  @ccall MAD_TPSA.mad_ctpsa_cplx(t1::Ptr{NewTPS{Float64}}, C_NULL::Ptr{Cvoid}, t::Ptr{NewTPS{Float64}})::Cvoid
  return t
end
#=
# --- zero ---
function zero(t::TPS)::TPS
  return TPS(mad_tpsa_new(t, MAD_TPSA_SAME))
end
