# --- Setters ---
seti!( t::NewTPS{Float64}, i, a, b)    = @ccall MAD_TPSA.mad_tpsa_seti( t::Ptr{NewTPS{Float64}}, i::Cint, a::Cdouble,     b::Cdouble)::Cvoid
setm!( t::NewTPS{Float64}, n, m, a, b) = @ccall MAD_TPSA.mad_tpsa_setm( t::Ptr{NewTPS{Float64}}, n::Cint, m::Ptr{Cuchar}, a::Cdouble, b::Cdouble)::Cvoid
setsm!(t::NewTPS{Float64}, n, m, a, b) = @ccall MAD_TPSA.mad_tpsa_setsm(t::Ptr{NewTPS{Float64}}, n::Cint, m::Ptr{Cint},   a::Cdouble, b::Cdouble)::Cvoid
setv!( t::NewTPS{Float64}, i, n, v)    = @ccall MAD_TPSA.mad_tpsa_setv( t::Ptr{NewTPS{Float64}}, i::Cint, n::Cint,        v::Ptr{Float64})::Cvoid

seti!( t::NewTPS{ComplexF64}, i, a, b)    = @ccall MAD_TPSA.mad_ctpsa_seti( t::Ptr{NewTPS{ComplexF64}}, i::Cint, a::ComplexF64,     b::ComplexF64)::Cvoid
setm!( t::NewTPS{ComplexF64}, n, m, a, b) = @ccall MAD_TPSA.mad_ctpsa_setm( t::Ptr{NewTPS{ComplexF64}}, n::Cint, m::Ptr{Cuchar}, a::ComplexF64, b::ComplexF64)::Cvoid
setsm!(t::NewTPS{ComplexF64}, n, m, a, b) = @ccall MAD_TPSA.mad_ctpsa_setsm(t::Ptr{NewTPS{ComplexF64}}, n::Cint, m::Ptr{Cint},   a::ComplexF64, b::ComplexF64)::Cvoid
setv!( t::NewTPS{ComplexF64}, i, n, v)    = @ccall MAD_TPSA.mad_ctpsa_setv( t::Ptr{NewTPS{ComplexF64}}, i::Cint, n::Cint,        v::Ptr{ComplexF64})::Cvoid
...
function lowget(t::Union{TPS,ComplexTPS}, i::Union{Nothing,Integer}, param::Union{Nothing,Integer}, params::Nothing)
  ...
  elseif !isnothing(i) && !isnothing(param)
    error("Invalid monomial index specified. Please use ONE of variable/parameter index, index by order, or index by sparse monomial.")
  elseif isnothing(param)
    return geti(t, Cint(i))
  else
    nv = numvars(t)
    return geti(t, Cint(nv+param))
  end
end
...
function lowget(t::Union{TPS,ComplexTPS}, ords::MIndexType, param::Nothing, params::Nothing)
  return getm(t, convert(Cint, length(ords)), collect(Cuchar, ords))
end
...
"""
lengthTPS(t::Union{TPS,ComplexTPS}) = len(t)
...
function hessian!(result, t::Union{TPS,ComplexTPS}; include_params=false)
  Base.require_one_based_indexing(result)
  d = Base.unsafe_convert(Ptr{Desc}, unsafe_load(t).d)
  desc = unsafe_load(d)
  n = desc.nv
  if include_params
    n += desc.np
  ...
  if check
    ...
    col = 1
    v = Ref{eltype(t)}()
    idx = cycle!(t, idx, Cint(0), C_NULL, v)
